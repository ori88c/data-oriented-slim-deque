...
exports.SlimDeque = exports.DEFAULT_SLIM_DEQUE_CAPACITY_INCREMENT_FACTOR = exports.DEFAULT_SLIM_DEQUE_INITIAL_CAPACITY = void 0;
exports.DEFAULT_SLIM_DEQUE_INITIAL_CAPACITY = 128;
exports.DEFAULT_SLIM_DEQUE_CAPACITY_INCREMENT_FACTOR = 1.5;
...
class SlimDeque {
     ...
     */
    constructor(initialCapacity = exports.DEFAULT_SLIM_DEQUE_INITIAL_CAPACITY, capacityIncrementFactor = exports.DEFAULT_SLIM_DEQUE_CAPACITY_INCREMENT_FACTOR) {
        this._frontIndex = 0;
        this._size = 0; // The current number of items stored in the deque.
        this._numberOfCapacityIncrements = 0;
        if (!isNaturalNumber(initialCapacity)) {
            throw new Error(`Failed to instantiate SlimDeque: initialCapacity must be a natural number, ` +
     ...
     */
    getSnapshot() {
        const snapshotFrontToBack = new Array(this._size);
        let snapshotIndex = 0;
        this._traverseFromFrontToBack((currentIndex) => {
    ...
    _validateCapacityIncrementFactor(factor) {
        if (factor < MIN_ALLOWED_CAPACITY_INCREMENT_FACTOR) {
            throw new Error(`Failed to instantiate SlimDeque: The provided capacityIncrementFactor of ` +
     ...
     */
    _traverseFromFrontToBack(callback) {
...
exports.SlimDeque = SlimDeque;
function isNaturalNumber(num) {
    const floored = Math.floor(num);
    return floored >= 1 && floored === num;
}
//# sourceMappingURL=data-oriented-slim-deque.js.map